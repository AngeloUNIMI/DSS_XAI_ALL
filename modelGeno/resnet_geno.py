...
class ResNet(nn.Module):
    ...
    def _forward_impl(self, x: Tensor) -> Tensor:
        ...
        # return also features flatten for metric learning
        features_flatten = x
...
def resnet18_orth_mtl(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> ResNet:
...
def resnet34_orth_mtl(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> ResNet:
    r"""ResNet-18 model from
    `"Deep Residual Learning for Image Recognition" <https://arxiv.org/pdf/1512.03385.pdf>`_.
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
